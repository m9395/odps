...
MaxCompute使用Hive UDF的示例请参见[Hive UDF兼容示例](/cn.zh-CN/开发/SQL及函数/UDF/Java UDF.md)。
...
1.  在MaxCompute[客户端](/cn.zh-CN/工具及下载/客户端.md)上执行如下命令将本地准备好的两个依赖JAR包上传至目标Project。
    ...
    关于ADD命令的使用，更多信息请参见[添加资源](/cn.zh-CN/开发/常用命令/资源操作.md)。
