...
3.  Run the tunnel upload command to import data to the wc\_in1 and wc\_in2 tables.
...
If the job is successful, the following data is returned in the mr\_multiinout\_out1 table:
